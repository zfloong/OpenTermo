      ...
      <DialogContent className="max-w-3xl h-auto max-h-[85vh] p-0 overflow-hidden rounded-2xl flex flex-col" style={{
        ...
        <div className="px-5 py-2.5 border-b border-outline-variant/20 flex items-center justify-between shrink-0" style={{ background: "var(--surface-container)" }}>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-[15px] font-semibold text-on-surface">新建连接</h2>
        ...
        <div className="px-5 py-4 overflow-y-auto flex-1">
          <div className="space-y-4">
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 bg-surface-dim p-3.5 rounded-xl border border-outline-variant/30">
                <div>
                ...
                <div className="md:col-span-3">
                  ...
                  <div className="relative">
                    <select
                      ...
                      style={{
                        backgroundImage: "url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%23757684' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e\")",
